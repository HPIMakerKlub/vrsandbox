...
PREREQUISITE_PACKAGES="gcc-c++ libudev-devel libusb1-devel zlib-devel libpng-devel libjpeg-devel libtiff-devel alsa-lib-devel speex-devel openal-soft-devel libv4l-devel libdc1394-devel libogg-devel libtheora-devel bluez-libs-devel mesa-libGL-devel mesa-libGLU-devel"
